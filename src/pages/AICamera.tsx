...
export default function AICamera() {
  ...
  const texts = {
    es: {
      ...
      benefit1: "Escáner de comida con IA",
      benefit1Desc: "$2 USD/mes en créditos de IA incluidos",
    ...
    en: {
      ...
      benefit1: "AI Food Scanner",
      benefit1Desc: "$2 USD/month in AI credits included",
