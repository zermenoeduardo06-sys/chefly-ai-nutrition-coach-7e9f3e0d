      ...
      <header>
        <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50" role="navigation" aria-label="Main navigation">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            <span className="text-3xl font-brand font-black bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent tracking-tight drop-shadow-lg">
              Chefly.AI
            </span>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6 lg:space-y-8 animate-fade-in order-1">
              ...
              <h1 id="hero-heading" className="text-5xl lg:text-7xl leading-tight">
                <span className="font-brand font-black bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent tracking-tight text-glow-primary">
                  Chefly.AI
                </span>
              </h1>
