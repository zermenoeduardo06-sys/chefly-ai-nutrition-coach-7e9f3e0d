...
import { Flame, Trash2, Clock, ChevronRight, ImageOff } from 'lucide-react';
              ...
              {dateScans.map((scan, index) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-sm truncate">{scan.dish_name}</h4>
                    ...
                    {scan.meal_type && (
                      <span className="inline-block mt-1.5 px-2 py-0.5 bg-primary/10 text-primary text-[10px] font-medium rounded-full capitalize">
                        {scan.meal_type}
                      </span>
                    )}
                  </div>
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-9 w-9 text-muted-foreground hover:text-destructive hover:bg-destructive/10 rounded-xl flex-shrink-0"
