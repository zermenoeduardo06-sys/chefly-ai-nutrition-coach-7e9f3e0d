...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-full p-2 text-foreground/70 opacity-100 transition-all hover:bg-foreground/10 hover:text-foreground active:scale-95 group-[.destructive]:text-red-300 group-[.destructive]:hover:bg-red-500/20 group-[.destructive]:hover:text-red-50 focus:outline-none focus:ring-2 focus:ring-ring group-[.destructive]:focus:ring-red-400",
      className,
    )}
    toast-close=""
    {...props}
